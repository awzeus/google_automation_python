# Fill in the blanks to make the is_power_of function return whether the number is 
# a power of the given base. Note: base is assumed to be a positive number. 
