...
def is_palindrome(input_string):
	...
	new_string = ""
	reverse_string = "" #.lower().split().replace(" ", "")[::-1]
...
# Fill in the gaps in the nametag function so that it uses the format method to return f
# irst_name and the first initial of last_name followed by a period. For example, nametag("Jane", "Smith") 
